...
const CONTACT_LINKS = [
  { label: 'fadhliardiansyah@gmail.com', href: 'mailto:fadhliardiansyah@gmail.com' },
  { label: "Let's chat",                 href: 'https://wa.me/6281219299192', target: '_blank' },
  { label: 'Download CV',                href: '/assets/Fadhli_Ardiansyah_CV.pdf', download: true },
];
...
export default function Footer() {
  ...
  return (
    <>
      <footer className={styles.footer} id="footer">
        <div className={styles.inner}>
          ...
          <div className={styles.top}>
            ...
            <div>
              <div className={styles.logoWrap}>
                <img src="/assets/logo.svg" alt="Fadhli Logo" width={28} height={28} />
              </div>
              <p className={styles.desc}>
                UI/UX Designer crafting digital experiences that balance business
                goals with human needs. Based in Indonesia, working globally.
              </p>
          ...
          <div className={styles.bottom}>
            <p className={styles.copy}>© 2026 Fadhli Ardiansyah. All rights reserved.</p>
            <p className={styles.made}>Designed with <span>♥</span> in Indonesia</p>
          </div>
      ...
      {/* ── SCROLL TO TOP ── */}
      <button
        className={`${styles.scrollTop} ${showScrollBtn ? styles.scrollTopVisible : ''}`}
